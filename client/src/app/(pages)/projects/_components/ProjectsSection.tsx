        ...
        >
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16">
                    <h2
                        ref={titleRef}
                        className="text-5xl md:text-7xl font-bold text-white mb-6 bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent"
                    >
                        PROJECTS
                    </h2>
                ...
                >
                    {filteredProjects.map((project, index) => (
                        <div
                            ...
                            className="group relative bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/10 hover:border-white/30 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/10 hover:-translate-y-2"
                        >
                            {/* Project Image */}
                ...
                {filteredProjects.length === 0 && (
                    <div className="text-center py-20">
                        ...
                        <p className="text-gray-400">Try switching to a different category.</p>
                    </div>
                )}
            </div>
        </section>
